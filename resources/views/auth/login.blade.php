                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small class="text-danger" id="login_email_error">Email Field Cannot Be Empty</small>
                        </div>

                        <div class="form-group">
                            <label for="password"> Password </label>
                            <input type="password" name="password" id="password" class="form-control" placeholder="Enter Password" value="{{ old('password') }}"/>
                            <small class="text-danger" id="login_password_error">Password Field Cannot Be Empty</small>
                        </div>
                    </div>

                    <div class="card-footer d-inline-block">
                        <button type="submit" class="btn btn-primary"> Login </button>
                        <p class="float-right mt-2"> Don't have an account?  <a href="{{ url('register')}}" class="text-primary"> Register </a> </p>
                    </div>
                    @csrf
                </div>
            </form>
